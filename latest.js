...
let li = document.createElement("li");
 if(ele.name=="Latest")  {li.className="active"; li.style.color="#00b1cd";}
...
let arrOfLatestNews=[
   ...
   {cat:"LIFESTYLE", news:"7 tips to bring excitement back into your long-term relationship",date:"Published on"},
   {cat:"LIFESTYLE", news:"Haryana to build the largest safari outside Africa on more than 10,000 acres",date:"Published on"},
   {cat:"BOLLYWOOD", news:"'Apsara of Bollywood' Aishwarya Rai looks elegant in white in her latest pics",date:"Published on"},
...
document.querySelector("#latest-news-under").append(div);
})
...
div2.append(img);
div.append(div1,div2);
document.querySelector("#latest-news-under-2").append(div);
})